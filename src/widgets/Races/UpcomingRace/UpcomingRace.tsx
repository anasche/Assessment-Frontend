    ...
    <section className="pb-8 md:pb-12 bg-white">
      <div className="mx-auto px-4 md:px-6 lg:px-[20px] max-w-[1688px]">
        <div className="flex flex-col lg:flex-row justify-center items-center gap-6 md:gap-8">
          {/* Upcoming Event Card */}
          <div className="flex flex-col rounded-[20px] md:rounded-[30px] lg:rounded-[40px] overflow-hidden w-full lg:w-[598px] h-[445px] text-white shadow-2xl">
            {/* Header */}
            ...
            <div className="bg-[#000057] flex-1 relative p-6 md:p-8 lg:p-10 flex flex-col justify-center overflow-hidden">
              ...
              <div className="relative z-10 flex justify-between items-center pb-2 md:pb-4 w-full">
                {/* Event Country */}
                <div className="flex items-center gap-3 md:gap-4 lg:gap-5 min-w-0">
                  ...
                  <div className="flex flex-col gap-0.5 md:gap-1 text-left min-w-0">
                    ...
                    <span className="text-2xl md:text-3xl lg:text-[40px] font-syne font-bold truncate flex items-center gap-2">
                ...
                <div className="flex items-center gap-3 md:gap-4 lg:gap-5 min-w-0">
                  ...
                  <div className="flex flex-col gap-0.5 md:gap-1 text-left min-w-0">
                    ...
                    <span className="text-2xl md:text-3xl lg:text-[40px] font-syne font-bold font-normal truncate">
                      1 may, 2025
                    </span>
                  </div>
                </div>
          ...
          <div className="flex flex-col rounded-[20px] md:rounded-[30px] lg:rounded-[40px] overflow-hidden w-full lg:w-[598px] h-[445px] text-white shadow-2xl border border-white/5">
            {/* Header */}
            <div className="bg-[#151585] py-6 px-6 md:px-8 lg:px-10 text-center z-10 relative">
              <h3 className="text-2xl md:text-3xl lg:text-[40px] font-syne font-bold mb-2">
                Event Countdown
